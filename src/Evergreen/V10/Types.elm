...
import Evergreen.V10.MatchSetup
import Evergreen.V10.NetworkModel
...
type MatchSetupMsg_
    ...
    | PressedPrimaryColor Evergreen.V10.ColorIndex.ColorIndex
    | PressedSecondaryColor Evergreen.V10.ColorIndex.ColorIndex
    | PressedDecal Evergreen.V10.Decal.Decal
    | TypedMatchName String
    | PressedPlayerMode Evergreen.V10.MatchSetup.PlayerMode
    | PressedSaveMatchName Evergreen.V10.MatchName.MatchName
    | PressedResetMatchName
    | TypedTextMessage String
    | SubmittedTextMessage Evergreen.V10.TextMessage.TextMessage
...
type alias LobbyData =
    { lobbies : AssocList.Dict (Evergreen.V10.Id.Id LobbyId) Evergreen.V10.MatchSetup.LobbyPreview
    }
...
type alias MatchPage_ =
    { timelineCache : Evergreen.V10.Timeline.TimelineCache Evergreen.V10.MatchSetup.MatchState
    , userIds : AssocList.Dict (Evergreen.V10.Id.Id Evergreen.V10.User.UserId) (Effect.WebGL.Mesh Vertex)
...
type alias MatchSetupPage_ =
    { lobbyId : Evergreen.V10.Id.Id LobbyId
    , networkModel :
        Evergreen.V10.NetworkModel.NetworkModel
            { userId : Evergreen.V10.Id.Id Evergreen.V10.User.UserId
            , msg : Evergreen.V10.MatchSetup.MatchSetupMsg
            }
            Evergreen.V10.MatchSetup.MatchSetup
    , matchData : MatchData
    }
...
type alias BackendModel =
    ...
    , lobbies : AssocList.Dict (Evergreen.V10.Id.Id LobbyId) Evergreen.V10.MatchSetup.MatchSetup
    , counter : Int
    }
...
type ToBackend
    = CreateMatchRequest
    | MatchSetupRequest (Evergreen.V10.Id.Id LobbyId) Evergreen.V10.MatchSetup.MatchSetupMsg
    | PingRequest
...
type ToFrontend
    = CreateLobbyResponse (Evergreen.V10.Id.Id LobbyId) Evergreen.V10.MatchSetup.MatchSetup
    | RemoveLobbyBroadcast (Evergreen.V10.Id.Id LobbyId)
    | CreateLobbyBroadcast (Evergreen.V10.Id.Id LobbyId) Evergreen.V10.MatchSetup.LobbyPreview
    | ClientInit (Evergreen.V10.Id.Id Evergreen.V10.User.UserId) LobbyData
    | JoinLobbyResponse (Evergreen.V10.Id.Id LobbyId) (Result JoinLobbyError Evergreen.V10.MatchSetup.MatchSetup)
    | PingResponse Effect.Time.Posix
    | MatchSetupBroadcast (Evergreen.V10.Id.Id LobbyId) (Evergreen.V10.Id.Id Evergreen.V10.User.UserId) Evergreen.V10.MatchSetup.MatchSetupMsg (Maybe LobbyData)
